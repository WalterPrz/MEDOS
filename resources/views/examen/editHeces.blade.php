...
<div class="row">
    <div class="col-md-12">
        <div class="card card-post" id="post_card">
            ...
            <form method="POST" action="{{route('examen.updateHeces', ['examen'=> $examen->id, 'detaHeces'=> $detaHeces->id] )}}" enctype="multipart/form-data" class="mb-0 needs-validation" role="form">
                @method('PUT')
                @csrf()
                <div class="card-body">
                    <div class="row">
