                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input id="nombrePaciente" class="form-control" name="nombrePaciente" value="{{old('nombrePaciente')}}" >
                                    </div>
                                </div>
                                <div class="form-group has-feedback row">
                                    <label for="edadPaciente" class="col-12 control-label">Edad del paciente:</label>
                                    <div class="col-12">
                                        <input name="edadPaciente" class="form-control" type="number" min="1" max="200" step="1" value="{{old('edadPaciente')}}" id="edadPaciente"></input>
                                    </div>
                                </div>
                                <div class="form-group has-feedback row">
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="telefonoPaciente" class="form-control" value="{{old('telefonoPaciente')}}" id="telefonoPaciente"></input>
                                    </div>
                                </div>
                                <div class="form-group has-feedback row">
                                    <label for="alergias" class="col-12 control-label">Alergias:</label>
                                    <div class="col-12">
                                        <textarea name="alergias" class="form-control" id="alergias" rows="5">{{old('alergias')}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group has-feedback row">
                                    <label for="fechaApertura" class="col-12 control-label">Fecha de apertura:</label>
                                    <div class="col-12">
                                        <input name="fechaApertura" class="form-control" value="{{old('fechaApertura', $fechaFormato)}}" id="fechaApertura" disabled></input>
                                    </div>
                                </div>
                            </div>
                        </div>
