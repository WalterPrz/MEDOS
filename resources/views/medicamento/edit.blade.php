                        ...
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="col-12">
                                        <select class="categoria_id form-control" name="categoria_id" id="categoria_id" value="{{old('categoria_id')}}">
                                            <option selected='true' disabled='disabled'>Seleccionar categoria de medicamento</option>
                                                ...
                                                <option value="{{ $item->id }}" @if($medicamento->categoria_id == $item->id) {{ 'selected' }} @endif>{{ $item->nombre }}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="nombre_comercial" class="form-control" type="text"value="{{ old('nombre_comercial',$medicamento->nombre_comercial) }}" id="nombre_comercial"></input>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="presentacion" class="form-control" type="text" value="{{ old('presentacion',$medicamento->presentacion) }}" id="presentacion"></input>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="componentes" class="form-control" type="text" value="{{ old('componentes',$medicamento->componentes) }}" id="componentes"></input>
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="precio_venta" class="form-control" type="number" min="0.01" max="999" step="0.01" value="{{ old('precio_venta',$medicamento->precio_venta) }}" id="precio_venta"></input>
                                    </div>
                                </div>
                            </div>
                        </div>
