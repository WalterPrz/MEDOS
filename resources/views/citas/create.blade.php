    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-post" id="post_card">
                ...
                <form method="POST" action="/citas" enctype="multipart/form-data" class="mb-0 needs-validation" role="form">
                {{ csrf_field() }}
                <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                            @error('especialidad')
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                    <input id="especialidad" type="text" class="form-control" name="especialidad" value="{{old('especialidad')}}" placeholder="Especialidad" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                    <input id="paciente" type="text" class="form-control" name="paciente" value="{{old('paciente')}}" placeholder="Paciente">
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                    <input id="fecha_cita" type="date" class="form-control" name="fecha_cita" value="{{old('fecha_cita')}}" placeholder="Fecha de la cita">
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                    <input id="descripcion" type="text" class="form-control" name="descripcion" value="{{old('descripcion')}}" placeholder="Detalles de la cita">
                                    </div>
                                </div>
