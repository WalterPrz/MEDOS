                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="cantidadAbonada" class="form-control" type="number" min="0.00" max="{{$maxVal}}" step="0.01" value="{{ old('cantidadAbonada') }}" id="cantidadAbonada"></input>
                                    </div>
                                </div>
                                </div>
                            </div>
